    ...
    return (
        <div className="container">
            ...
            <p className="forgot-password">
                ...
                <Link onClick={closeModal}> Se connecter</Link>
            </p>
...
export function MaterialSymbolsCloseRounded(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}>
            <path fill="currentColor" d="m12 13.4l-4.9 4.9q-.275.275-.7.275t-.7-.275t-.275-.7t.275-.7l4.9-4.9l-4.9-4.9q-.275-.275-.275-.7t.275-.7t.7-.275t.7.275z"></path>
        </svg>
    );
}
